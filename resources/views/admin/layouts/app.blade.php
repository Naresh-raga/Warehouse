...
<body>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    @if (\Auth::user()->role_id == 1)
                        <li class="">
                            <a href="{{url('admin/home')}}"><i class="menu-icon fa fa-laptop"></i>Dashboard </a>
                        </li>
                        <li class="">
                            <a href="{{ route('cms-pages.index') }}"><i class="menu-icon fa fa-cogs"></i>Pages </a>
                        </li>
                        <li class="">
                            <a href="{{ route('blog.index') }}"><i class="menu-icon fa fa-window-restore"></i>Manage Blogs</a>
                        </li>
                        <li class="">
                            <a href="{{ route('etemplate.index') }}"><i class="menu-icon fa fa-envelope"></i>Email Templates</a>
                        </li>
                        <li class="">
                            <a href="{{ route('roles.index') }}"><i class="menu-icon fa fa-road"></i>Roles</a>
                        </li>
                        <li class="">
                            <a href="{{ route('permission.edit',[1]) }}"><i class="menu-icon fa fa-podcast"></i>Permission</a>
                        </li>
                        <li class="">
                            <a href="{{ route('category.index') }}"><i class="menu-icon fa fa-snowflake-o"></i>Category</a>
                        </li>
                        <li class="">
                            <a href="{{ route('users.index') }}"><i class="menu-icon fa fa-users"></i>Users</a>
                        </li>
                        <li class="">
                            <a href="{{ route('product-types.index') }}"><i class="menu-icon fa fa-product-hunt"></i>Product Types</a>
                        </li>
                        <li class="">
                            <a href="{{ route('warehouse.index') }}"><i class="menu-icon fa fa-home"></i>Warehouses</a>
                        </li>
                    @endif
                    @if (\Auth::user()->role_id == 2)
                        <li class="">
                            <a href="{{url('manager/home')}}"><i class="menu-icon fa fa-laptop"></i>Dashboard </a>
                        </li>
                        <li class="">
                            <a href="{{ route('warehouse.index') }}"><i class="menu-icon fa fa-home"></i>Warehouses</a>
                        </li>
            ...
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="{{url('/')}}">
                        <img src="{{asset('logo_short.png')}}" alt="Logo">
                        <!-- <h1><b>WMS</b></h1> -->
                    </a>
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            ...
                            @if (\Auth::user()->role_id == 2)
                                <a class="nav-link" href="{{route('manager.edit.profile')}}"><i class="fa fa -cog"></i>Edit Profile</a>
                            @endif
    ...
    <script>
        var dt = {
            'cms': "{{route('cms-pages.index')}}",
            'blog': "{{route('blog.index')}}",
            'et': "{{route('etemplate.index')}}",
            'role': "{{route('roles.index')}}",
            'cat': "{{route('category.index')}}",
            'testimonial': "{{route('testimonial.index')}}",
            'users': "{{route('users.index')}}",
            'pt': "{{route('product-types.index')}}",
            'wh': "{{route('warehouse.index')}}",
            'ft': "{{route('food-type.index')}}",
        };
        ...
        function updates(v) {
            $.get("{{url('admin/ckc')}}",{'model':v.attr('data-model'),'id':v.attr('data-id')},function(){});
        };
    </script>
    <script src="{{asset('assets/js/data-table-init.js')}}"></script>
</body>
</html>
